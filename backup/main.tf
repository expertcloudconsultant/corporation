...
resource "azurerm_virtual_network_peering" "hub-to-prod-spoke-peering" {
  name                      = "corporate-hub-to-corporate-prod-peering"
  resource_group_name       = "${azurerm_resource_group.corporate-production-rg.name}"
  virtual_network_name      = azurerm_virtual_network.corporate-hub-vnet.name
...
resource "azurerm_virtual_network_peering" "prod-spoke-to-hub-peering" {
  name                      = "corporate-prod-to-corporate-hub-peering"
  resource_group_name       = "${azurerm_resource_group.corporate-production-rg.name}"
  virtual_network_name      = "${azurerm_virtual_network.corporate-prod-vnet.name}"
...
resource "azurerm_lb" "corporate-business-tier-lb" {
  name                = "corporate-business-tier-lb"
  location            = var.avzs[0]
  resource_group_name = "${azurerm_resource_group.corporate-production-rg.name}"
...
resource "azurerm_network_interface" "nic" {
  name                = "corporate-nic-${count.index + 1}"
  location            = var.avzs[0]
  resource_group_name = "${azurerm_resource_group.corporate-production-rg.name}"
  count               = 2
...
resource "azurerm_linux_virtual_machine" "corporate-business-linux-vm" {
  ...
  computer_name                   = "corporate-linux-vm01"
...
#"${azurerm_resource_group.{var.corp}-production-rg.location}"
#"${azurerm_resource_group.corporate-production-rg.location}"
#"${azurerm_resource_group.{var.corp}-production-rg.location}"
#"{azurerm_resource_group.corporate-production-rg.location}"
#"{azurerm_resource_group.corporate-production-rg.location}"
# azurerm_resource_group.corporate-production-rg.location
...
#"${azurerm_resource_group.corporate-production-rg.location}"
#"${azurerm_resource_group.{var.corp}-production-rg.location}"
#"azurerm_resource_group.corporate-production-rg.name"
#"${azurerm_resource_group.corporate-production-rg.name}"
#"${azurerm_resource_group.corporate-production-rg.location}"
#"${azurerm_resource_group.{var.corp}-production-rg.location}"
#"${azurerm_resource_group.corporate-production-rg.name}"
